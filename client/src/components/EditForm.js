...
class EditForm extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    restService.updateHomework(this.props.location.aboutProps._id, this.state.homework, result => {
      if(!result) {
  ...
  render()
  {
    return (
      <form className="form-edit" onSubmit={ this.handleSubmit }>
        ...
        <input onChange={ this.handleChange } name="title" type="text" id="inputTitle" className="form-control" placeholder="Final Assignment" required autoFocus value={this.state.homework.title} />
        ...
        <input onChange={ this.handleChange } name="score" type="text" id="inputScore" className="form-control" placeholder="100" required  value={this.state.homework.score} />
        ...
        <input onChange={ this.handleChange } name="due_date" type="date" id="inputDueDate" className="form-control" required  value={this.state.homework.due_date} />
        ...
        <input onChange={ this.handleChange } name="name" type="text" id="inputSchoolName" className="form-control" placeholder="Amazing high school" required  value={this.state.homework.school.name} />
        ...
        <input onChange={ this.handleChange } name="address" type="text" id="inputSchoolAddress" className="form-control" placeholder="Halifax, N.S." required  value={this.state.homework.school.address} />
        ...
        <input onChange={ this.handleChange } name="logo" type="text" id="inputSchoolLogo" className="form-control" placeholder="http:\\Logo.com" required  value={this.state.homework.school.logo} />
